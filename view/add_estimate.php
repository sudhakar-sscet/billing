<?php
 ...
 ?>
 	<div class="container">
	 	<h3 class="text-center">Add Estimate</h3>
		<form method="post" action="../controller/add_estimate_controller.php">
			...
			<div class="box">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table">
						...
						<tbody>
							<tr>
								<td><input type="text" id="est_product_name_comp_1" name="product_name[]" class="form-control product_name_comp" autofocus required></td>
								<td><input type="text" id="est_price_1" name="price[]" class="form-control" required></td>
								<td><input type="number" id="est_qty_1" name="qty[]" class="form-control est_qty" autofocus required></td>
								<td><input type="text" id="est_total_1" name="total[]" class="form-control" required></td>
								<td>...</td>
							</tr>
						</tbody>
					</table>
				...
				<div class="box-footer">
					<div class="row">
						...
						<div class="col-sm-3 form-group">
							...
							<input type="text" id="est_bill_total" name='grand_total' class="form-control" required placeholder="Total" readonly>
						</div>
					</div>
				</div>
			</div>
