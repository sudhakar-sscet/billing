                        ...
                        <div class="col-md-12">
                            <div class="row invoice-info" style="border:1px solid #e2e2e2;border-bottom:none;">
                                ...
                                <div class="col-xs-5" style="border-right:1px solid #e2e2e2;padding-top:2px;padding-bottom:2px;">
                                    ...
                                    <span>RAMESH</span>
                                    <br>
                                    <p><span>NO 5/10 J K TOWERS PARI SALAI MOGAPPAIR EAST THIRUVALLUR </span></p>
                                    <span>GSTN  : </span>
                                    <br>
                                    <span>Mobile  : </span>
                                    <span> 7777777722</span>
                                    <br>
                                </div>
                                <div class="col-xs-3" style="border-right:1px solid #e2e2e2;padding-top:2px;padding-bottom:2px;">
                                    ...
                                    <br>
                                    <span>Bill no: <?php echo $bill['bill_no']; ?></span>
                            ...
                            <div class="col-xs-12 table-responsive">
                                <table class="table table-striped table-bordered" style="margin-bottom:0px;">
                                    ...
                                    <tfoot>
                                        ...
                                        <th colspan="2"></th>
                                        <th><?php echo $bill['grand_total']; ?></th>
                                    </tfoot>
                                </table>
                                <!-- bottom bar -->
                                        ...
                                        <table class="table table-bordered" style="margin-bottom:0px;border-bottom:none !important">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="padding-top:7px;padding-bottom:7px;font-weight:normal"><?php echo round($bill['grand_total']); ?></th>
                                                </tr>
                                                <tr>
                                                    <th style="width:58.5%;padding-top:7px;padding-bottom:7px;"> Grand Total</th>
                                                    <th style="padding-top:7px;padding-bottom:7px;"><?php echo round($bill['grand_total']); ?></th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
